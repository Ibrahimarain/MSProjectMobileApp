            ...
            <Image
              ...
              source={
                this.params?.isSuccess
                  ? require('../assets/tick_icon.png')
                  : require('../assets/cross_icon.png')
              }
            />

            <Text
              style={{
                ...GlobalStyles.Bold(5, color),
                marginTop: WP(4),
                width: '70%',
                textAlign: 'center',
              }}
              numberOfLines={2}>
              {this.params?.title ? this.params?.title : 'Alert'}
            </Text>
            {this.params?.message && (
              <Text
                style={{
                  ...GlobalStyles.semiBold(3.5, Colors.gray),
                  marginTop: WP(2),
                  width: '70%',
                  textAlign: 'center',
                }}
