...
import { FlatList, Image, Text, SafeAreaView, View, TouchableOpacity, LogBox, TextInput } from 'react-native';
...
export default MainScreen = () => {
    ...
    const uploadVideo = (imageRes, data) => {
        ...
        RNFetchBlob.fetch('POST', Constants.BASE_URL+'/upload_api', {
...
uploadVideo(images, images.path.replace("file://", ""))
                ...
                >
                    ...
                    <TextInput
                    value={baseURL}
                    style={{width:"100%", position:"absolute", backgroundColor:Colors.lightGray, top:0, height:WP(12)}}
                    onChangeText={(text)=>{
